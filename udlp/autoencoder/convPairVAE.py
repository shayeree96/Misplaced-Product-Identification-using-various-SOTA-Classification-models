...
class ConvPairVAE(nn.Module):
    ...
    def pair_forward(self, x1, x2):
        ...
        patch_cls = patch_cls.view(-1, 16 * 11)
    ...
    def test(self, testloader):
        ...
        correct = 0
        predict = []
        for batch_idx, (input1, input2, label) in enumerate(testloader):
            input1 = input1.float()
            input2 = input2.float()
            if use_cuda:
        ...
        return torch.cat(predict), valid_acc